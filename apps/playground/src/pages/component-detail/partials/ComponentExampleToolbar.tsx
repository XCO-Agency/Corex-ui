  ...
  return (
    <div className="inline-flex items-center rounded-lg border border-border/80 bg-muted/30 p-0.5 shadow-2xs shrink-0">
      <button
        ...
        className={cn(base, activeTab === "preview" ? active : inactive)}
      >
        Preview
      </button>
      <button
        ...
        className={cn(base, activeTab === "code" ? active : inactive)}
      >
        Code
      </button>
    </div>
        ...
        <TooltipTrigger
          render={
            <Button
              ...
              variant="ghost"
              size="icon-xs"
              className={cn(iconBase, viewport === "100%" ? activeStyle : inactiveStyle)}
        ...
        <TooltipTrigger
          render={
            <Button
              ...
              variant="ghost"
              size="icon-xs"
              className={cn(iconBase, viewport === "768px" ? activeStyle : inactiveStyle)}
        ...
        <TooltipTrigger
          render={
            <Button
              ...
              variant="ghost"
              size="icon-xs"
              className={cn(iconBase, viewport === "375px" ? activeStyle : inactiveStyle)}
        ...
        <TooltipTrigger
          render={
            <Button
              ...
              variant="ghost"
              size="icon-xs"
              className="size-6 rounded text-muted-foreground hover:text-foreground hover:bg-background/80 cursor-pointer"
      ...
      >
        {isBlock ? (
          <>
            ...
            <span className="truncate max-w-[160px] sm:max-w-[220px] xl:max-w-none">
              {actionText}
            </span>
          </>
        ) : (
