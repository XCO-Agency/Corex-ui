...
import { getPresetDefinitions, resolvePresetDefinitions } from "./datePickerExpressions";
...
/**
 * Resolves the reusable semantic preset tree (see `datePickerExpressions.ts`) into
 * the `DatePresetItemType[]` shape the DatePicker UI renders. Every relative preset
