...
declare function reactWrap$1<Props extends object, ElementType extends HTMLElement>(
  React: React,
  tagName: string,
  { slots, readOnlyProps }?: PropConfig<Props>,
): ForwardRefExoticComponent<
  PropsWithoutRef<PropsWithChildren<Props>> & RefAttributes<ElementType>
>;
...
interface FieldProps
  extends BasicFieldProps, InputProps, FocusEventProps, FieldDetailsProps {
  /**
...
interface CheckboxProps$1
  extends GlobalProps, BaseCheckableProps, FieldErrorProps, FieldDetailsProps {
  /**
...
type DateAutocompleteField = ExtractStrict<
  AnyAutocompleteField,
  | "bday"
  | "bday-day"
  | "bday-month"
...
interface HeadingProps$1
  extends GlobalProps, AccessibilityVisibilityProps, BlockTypographyProps {
  /**
...
interface ModalProps$1
  extends GlobalProps, BaseOverlayProps, BaseOverlayMethods, ActionSlots {
  /**
 ...
 * };
 */
type CallbackEventListener<T extends keyof HTMLElementTagNameMap> =
  | (EventListener & {
...
interface PreactBaseElementPropsWithChildren<
  TClass extends HTMLElement,
...
interface AvatarProps extends Required<
  Pick<AvatarProps$1, "initials" | "src" | "alt" | "size">
> {
  size: Extract<
    AvatarProps$1["size"],
...
interface IconProps extends Required<
...
interface ReactProps$V
  extends Partial<BadgeProps>, Pick<BadgeProps$1, "id" | "children"> {
  /**
   * The content of the Badge.
   */
...
interface BannerProps extends Pick<
  RequiredBannerProps,
...
interface ReactProps$U
  extends Partial<BannerProps>, Pick<BannerProps$1, "id" | "children"> {
  /**
   * The content of the Banner.
   */
  children?: ComponentChildren$1;
...
declare module "preact" {
  namespace createElement.JSX {
    interface IntrinsicElements {
      [tagName$U]: Omit<ReactProps$U, "secondaryActions"> &
...
type BoxBorderRadii = Extract<
  ...
  | "large-200"
>;
type BoxBorderStyles = Extract<
  RequiredBoxProps["borderStyle"],
  "none" | "solid" | "dashed" | "auto"
>;
type ResponsiveBoxProps = MakeResponsivePick<
  RequiredBoxProps,
  | "padding"
  | "paddingBlock"
  | "paddingBlockStart"
  ...
  | "display"
>;
interface BoxProps extends Pick<
  RequiredBoxProps,
  | "accessibilityLabel"
  | "accessibilityRole"
...
interface ReactProps$S
  extends Partial<ButtonProps>, Pick<ButtonProps$1, "id" | "children"> {
  /**
   * The content of the Button.
   */
  children?: ComponentChildren$1;
...
interface PreactOverlayControlProps extends Pick<
  InteractionProps,
  "commandFor" | "interestFor"
> {
  /**
...
interface ButtonGroupProps extends Required<
  Pick<ButtonGroupProps$1, "gap" | "accessibilityLabel">
> {}

declare const tagName$R = "s-button-group";
interface ReactProps$R
  extends Partial<ButtonGroupProps>, Pick<ButtonGroupProps$1, "id" | "children"> {
  /**
   * The content of the ButtonGroup.
   */
  children?: ComponentChildren$1;
...
declare module "preact" {
  namespace createElement.JSX {
    interface IntrinsicElements {
      [tagName$R]: Omit<ReactProps$R, "primaryAction" | "secondaryActions"> &
...
type PreactInputProps = Required<
...
interface PreactCheckboxProps extends Required<
  Pick<
    CheckboxProps$1,
    | "accessibilityLabel"
    | "checked"
...
interface ReactProps$Q
  extends
    Partial<Omit<CheckboxProps, "error" | "details">>,
...
declare module "preact" {
  namespace createElement.JSX {
    interface IntrinsicElements {
      [tagName$Q]: Omit<ReactProps$Q, "error" | "details"> &
...
interface ChipProps extends Required<
...
declare module "preact" {
  namespace createElement.JSX {
    interface IntrinsicElements {
      [tagName$P]: Omit<ReactProps$P, "graphic"> &
        PreactBaseElementPropsWithChildren<Chip>;
    }
  }
}

interface ChoiceProps extends Required<
  Pick<
    ChoiceProps$1,
    "selected" | "defaultSelected" | "disabled" | "accessibilityLabel" | "value"
  >
> {}

declare const tagName$O = "s-choice";
interface ReactProps$O
  extends Partial<ChoiceProps>, Pick<ChoiceProps$1, "id" | "children" | "details"> {
  /**
   * Content to use as the choice label.
   *
...
declare module "preact" {
  namespace createElement.JSX {
    interface IntrinsicElements {
      [tagName$O]: Omit<ReactProps$O, "details" | "secondaryContent"> &
        PreactBaseElementPropsWithChildren<Choice>;
    }
  }
}

interface ChoiceListProps extends Required<
  Pick<
    ChoiceListProps$1,
    | "details"
    | "disabled"
...
interface ReactProps$N
  extends Partial<ChoiceListProps>, Pick<ChoiceListProps$1, "id" | "children"> {
  /**
   * The choices a user can select from.
   *
   * Accepts `Choice` components.
...
type ClickableBaseProps = Required<
  Pick<
    ClickableProps$1,
    | "command"
    | "commandFor"
...
interface ReactProps$M
  extends Partial<ClickableProps>, Pick<ClickableProps$1, "id" | "children"> {
  /**
...
interface ClickableChipProps extends Required<
  Pick<
...
interface ReactProps$L
  extends Partial<ClickableChipProps>, Pick<ClickableChipProps$1, "id" | "children"> {
  /**
...
declare const ClickableChipBase_base: (abstract new (
  ...
  Pick<typeof PolarisCustomElement, "prototype" | "observedAttributes">;
declare abstract class ClickableChipBase<TTagName extends keyof HTMLElementTagNameMap>
...
declare class ClickableChip
  extends ClickableChipBase<typeof tagName$L>
...
declare module "preact" {
  namespace createElement.JSX {
    interface IntrinsicElements {
      [tagName$L]: Omit<ReactProps$L, "graphic"> &
        PreactBaseElementPropsWithChildren<ClickableChip>;
    }
  }
}

type PreactFieldProps<Autocomplete extends string = string> = PreactInputProps &
  Required<
    Pick<
      TextFieldProps$1,
      | "defaultValue"
...
type ColorFieldProps = PreactFieldProps<Required<ColorFieldProps$1>["autocomplete"]> &
  Required<Pick<ColorFieldProps$1, "alpha" | "value" | "defaultValue">>;

declare const tagName$K = "s-color-field";
interface ReactProps$K
  extends
    Partial<Omit<ColorFieldProps, "accessory" | "error" | "details">>,
...
declare module "preact" {
  namespace createElement.JSX {
    interface IntrinsicElements {
      [tagName$K]: Omit<ReactProps$K, "error" | "details"> &
        FieldSlotPreactProps &
...
interface ReactProps$I
  extends
    Partial<Omit<DateFieldProps, "error" | "details">>,
...
declare abstract class DateFieldBase
  ...
  implements
    Pick<
      DateFieldProps,
      "allow" | "disallow" | "allowDays" | "disallowDays" | "view" | "defaultView"
    >
{
...
declare module "preact" {
  namespace createElement.JSX {
    interface IntrinsicElements {
      [tagName$I]: Omit<ReactProps$I, "error" | "details"> &
        FieldSlotPreactProps &
...
interface DatePickerProps extends Required<
  Pick<
    DatePickerProps$1,
    | "defaultView"
    | "view"
...
declare class DatePicker
  extends DatePickerBase<typeof tagName$H>
  implements DatePickerProps
{
  constructor();
}
...
interface DropZoneProps extends Required<
  Pick<
    DropZoneProps$1,
    | "accept"
    | "accessibilityLabel"
...
type EmailFieldProps = PreactFieldProps<Required<EmailFieldProps$1>["autocomplete"]> &
  Required<Pick<EmailFieldProps$1, "maxLength" | "minLength">>;

declare const tagName$E = "s-email-field";
interface ReactProps$E
  extends
    Partial<Omit<EmailFieldProps, "accessory" | "error" | "details">>,
...
declare module "preact" {
  namespace createElement.JSX {
    interface IntrinsicElements {
      [tagName$E]: Omit<ReactProps$E, "error" | "details"> &
        FieldSlotPreactProps &
...
type ResponsiveGridProps = MakeResponsivePick<
...
interface GridItemProps
  extends BoxProps, Required<Pick<GridItemProps$1, "gridColumn" | "gridRow">> {
...
interface ReactProps$C
  extends Partial<GridItemProps>, Pick<GridItemProps$1, "id" | "children"> {
  /**
...
interface HeadingProps extends Required<
  Pick<HeadingProps$1, "accessibilityRole" | "accessibilityVisibility" | "lineClamp">
> {}

declare const tagName$B = "s-heading";
interface ReactProps$B
  extends Partial<HeadingProps>, Pick<HeadingProps$1, "id" | "children"> {
  /**
   * The content of the Heading.
   */
  children?: ComponentChildren$1;
...
declare abstract class HeadingBase
  extends PolarisCustomElement
  implements
    Pick<HeadingProps, "accessibilityRole" | "accessibilityVisibility" | "lineClamp">
{
...
interface ReactProps$y
  extends Partial<LinkProps>, Pick<LinkProps$1, "id" | "lang" | "children"> {
  /**
   * The content of the Link.
   */
  children?: ComponentChildren$1;
...
declare abstract class LinkBase<TTagName extends keyof HTMLElementTagNameMap>
  ...
  implements
    Pick<
      LinkProps,
      "accessibilityLabel" | "interestFor" | "href" | "target" | "download" | "lang"
    >
{
...
interface ReactProps$x
  extends Partial<ListItemProps>, Pick<ListItemProps$1, "id" | "children"> {
  /**
   * The content of the ListItem.
   */
  children?: ComponentChildren$1;
...
interface ModalProps extends Pick<
...
interface ReactProps$v
  extends Partial<ModalProps>, Pick<ModalProps$1, "id" | "children"> {
  /**
...
declare abstract class ModalBase<TTagName extends keyof HTMLElementTagNameMap>
  ...
  implements Pick<ModalProps, "accessibilityLabel" | "heading" | "padding" | "size">
{
...
declare module "preact" {
  namespace createElement.JSX {
    interface IntrinsicElements {
      [tagName$v]: Omit<ReactProps$v, "primaryAction" | "secondaryActions"> &
...
interface ReactProps$u
  extends
    Partial<Omit<MoneyFieldProps, "error" | "details">>,
...
declare module "preact" {
  namespace createElement.JSX {
    interface IntrinsicElements {
      [tagName$u]: Omit<ReactProps$u, "error" | "details"> &
        FieldSlotPreactProps &
...
interface NumberFieldProps
  extends
    Omit<PreactFieldProps<Required<NumberFieldProps$1>["autocomplete"]>, "value">,
    Required<
      Pick<NumberFieldProps$1, "inputMode" | "max" | "min" | "prefix" | "step" | "suffix">
    > {
...
interface ReactProps$t
  extends
    Partial<Omit<NumberFieldProps, "error" | "details">>,
...
declare module "preact" {
  namespace createElement.JSX {
    interface IntrinsicElements {
      [tagName$t]: Omit<ReactProps$t, "error" | "details"> &
        FieldSlotPreactProps &
...
interface OptionProps extends Required<
  Pick<OptionProps$1, "disabled" | "value" | "selected" | "defaultSelected">
> {}

declare const tagName$s = "s-option";
interface ReactProps$s
  extends Partial<OptionProps>, Pick<OptionProps$1, "id" | "children"> {
  /**
   * The content to use as the label.
   */
  children?: ComponentChildren$1;
...
interface OptionGroupProps extends Required<
  Pick<OptionGroupProps$1, "disabled" | "label">
> {}

declare const tagName$r = "s-option-group";
interface ReactProps$r
  extends Partial<OptionGroupProps>, Pick<OptionGroupProps$1, "id" | "children"> {
  /**
   * The options a user can select from.
   *
   * Accepts `Option` components.
...
interface ParagraphProps extends Required<
  Pick<
    ParagraphProps$1,
    | "accessibilityVisibility"
    | "fontVariantNumeric"
...
interface ReactProps$o
  extends Partial<ParagraphProps>, Pick<ParagraphProps$1, "id" | "children"> {
  /**
   * The content of the Paragraph.
   */
  children?: ComponentChildren$1;
...
declare abstract class ParagraphBase
  ...
  implements
    Pick<
      ParagraphProps,
      "fontVariantNumeric" | "lineClamp" | "color" | "dir" | "accessibilityVisibility"
    >
{
...
type PasswordFieldProps = PreactFieldProps<
...
interface ReactProps$n
  extends
    Partial<Omit<PasswordFieldProps, "error" | "details">>,
...
declare module "preact" {
  namespace createElement.JSX {
    interface IntrinsicElements {
      [tagName$n]: Omit<ReactProps$n, "error" | "details"> &
        FieldSlotPreactProps &
...
interface PopoverProps extends Required<
  Pick<
    PopoverProps$1,
    | "blockSize"
    | "inlineSize"
...
interface ReactProps$m
  extends Partial<PopoverProps>, Pick<PopoverProps$1, "id" | "children"> {
  /**
...
declare class Popover
  extends PreactPopoverElement<typeof tagName$m>
  implements PopoverProps
{
  constructor();
}
...
type PressButtonBaseProps = Required<
  Pick<
    PressButtonProps$1,
    | "accessibilityLabel"
    | "disabled"
...
interface ReactProps$l
  extends Partial<PressButtonProps>, Pick<PressButtonProps$1, "children"> {
  /**
...
interface ReactProps$k
  extends Partial<QueryContainerProps$1>, Pick<QueryContainerProps$1, "id" | "children"> {
  /**
   * The content of the container.
   */
  children?: ComponentChildren$1;
...
interface QueryContainerProps extends Required<
  Pick<QueryContainerProps$1, "id" | "containerName">
> {}
...
interface ReactProps$j
  extends Partial<ScrollBoxProps>, Pick<BoxProps$1, "id" | "children"> {
  /**
...
declare abstract class ScrollBoxBase<TTagName extends keyof HTMLElementTagNameMap>
  extends PolarisCustomElement
...
declare class ScrollBox
  extends ScrollBoxBase<typeof tagName$j>
...
interface ReactProps$i
  extends
    Partial<Omit<SearchFieldProps, "error" | "details">>,
...
interface SectionProps extends Pick<
...
interface ReactProps$h
  extends Partial<SectionProps>, Pick<SectionProps$1, "id" | "children"> {
  /**
   * The content of the Section.
   */
  children?: ComponentChildren$1;
...
interface ReactProps$g
  extends
    Partial<Omit<SelectProps, "error" | "details">>,
...
declare module "preact" {
  namespace createElement.JSX {
    interface IntrinsicElements {
      [tagName$g]: Omit<ReactProps$g, "error" | "details"> &
        FieldSlotPreactProps &
...
type ResponsiveStackProps = MakeResponsivePick<
  AlignedStackProps,
...
interface StackProps
  extends
    BoxProps,
    Pick<Required<AlignedStackProps>, "justifyContent" | "alignItems" | "alignContent"> {
  /**
...
interface ReactProps$e
  extends Partial<StackProps>, Pick<StackProps$1, "id" | "children"> {
  /**
   * The content of the Stack.
   */
  children?: ComponentChildren$1;
...
interface TableProps extends Required<
  Pick<
    TableProps$1,
...
declare module "preact" {
  namespace createElement.JSX {
    interface IntrinsicElements {
      [tagName$c]: Omit<ReactProps$c, "filters"> &
...
interface ReactProps$b
  extends Partial<TableBodyProps>, Pick<TableBodyProps$1, "id" | "children"> {
  /**
   * The body of the table. May not have any semantic meaning in the Table's `list` variant.
   */
  children?: ComponentChildren$1;
...
interface ReactProps$a
  extends Partial<TableCellProps>, Pick<TableCellProps$1, "id" | "children"> {
  /**
   * The content of the table cell.
   */
  children?: ComponentChildren$1;
...
interface ReactProps$9
  extends Partial<TableHeaderProps>, Pick<TableHeaderProps$1, "id" | "children"> {
  /**
   * The heading of the column in the `table` variant, and the label of its data in `list` variant.
   */
  children?: ComponentChildren$1;
...
interface ReactProps$8
  extends Partial<TableHeaderRowProps>, Pick<TableHeaderRowProps$1, "id" | "children"> {
  /**
   * Contents of the table heading row; children should be `TableHeading` components.
   */
  children?: ComponentChildren$1;
...
interface ReactProps$7
  extends Partial<TableRowProps>, Pick<TableRowProps$1, "id" | "children"> {
  /**
   * The content of a TableRow, which should be `TableCell` components.
   */
  children?: ComponentChildren$1;
...
interface TextProps extends Required<
  Pick<
    TextProps$1,
    | "accessibilityVisibility"
    | "dir"
...
type TextAreaProps = PreactFieldProps<Required<TextAreaProps$1>["autocomplete"]> &
  Required<Pick<TextAreaProps$1, "maxLength" | "minLength" | "rows">>;

declare const tagName$5 = "s-text-area";
interface ReactProps$5
  extends
    Partial<Omit<TextAreaProps, "error" | "details">>,
...
declare module "preact" {
  namespace createElement.JSX {
    interface IntrinsicElements {
      [tagName$5]: Omit<ReactProps$5, "error" | "details"> &
        FieldSlotPreactProps &
...
> &
  Required<
    Pick<TextFieldProps$1, "icon" | "maxLength" | "minLength" | "prefix" | "suffix">
  >;

declare const tagName$4 = "s-text-field";
interface ReactProps$4
  extends
    Partial<Omit<TextFieldProps, "accessory" | "error" | "details">>,
    Pick<TextFieldProps$1, "id">,
...
declare abstract class TextFieldBase
  ...
  implements
    Pick<TextFieldProps, "icon" | "maxLength" | "minLength" | "prefix" | "suffix">
{
...
declare module "preact" {
  namespace createElement.JSX {
    interface IntrinsicElements {
      [tagName$4]: Omit<ReactProps$4, "accessory" | "error" | "details"> &
        FieldSlotPreactProps &
...
interface ThumbnailProps extends Required<
  Pick<ThumbnailProps$1, "src" | "alt" | "size">
> {
  size: Extract<
...
interface ReactProps$2
  extends Partial<TooltipProps>, Pick<TooltipProps$1, "id" | "children"> {
  /**
   * The content of the Tooltip.
   *
...
type URLFieldProps = PreactFieldProps<Required<URLFieldProps$1>["autocomplete"]> &
  Required<Pick<URLFieldProps$1, "maxLength" | "minLength">>;

declare const tagName$1 = "s-url-field";
interface ReactProps$1
  extends
    Partial<Omit<URLFieldProps, "accessory" | "error" | "details">>,
    Pick<URLFieldProps$1, "id">,
    FieldReactProps<typeof tagName$1>,
    FieldSlotInternalReactProps {}
...
declare module "preact" {
  namespace createElement.JSX {
    interface IntrinsicElements {
      [tagName$1]: Omit<ReactProps$1, "error" | "details"> &
        FieldSlotPreactProps &
...
interface ReactProps
  extends Partial<UnorderedListProps>, Pick<UnorderedListProps$1, "id"> {
  /**
...
declare function reactWrap<Props extends {}, ElementType extends HTMLElement>(
  React: React,
  tagName: string,
): ReturnType<typeof reactWrap$1>;
...
/** Used when an element has children. */
interface ReactBaseElementPropsWithChildren<
  TClass extends HTMLElement,
> extends ReactBaseElementProps<TClass> {
